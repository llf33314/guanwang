...
@Entity
@Table(name = "t_ws_product_center")
@org.hibernate.annotations.Table(appliesTo = "t_ws_product_center", comment = "产品中心")
public class ProductCenter {
	...
	@Column(name = "pcdetail", columnDefinition = "text COMMENT '产品中心详情'")
    private String pcdetail = "";

	@Column(name = "pcfeatures", columnDefinition = "text COMMENT '产品中心功能亮点'")
    private String pcfeatures = "";
    ...
    public void setPcdetail(String pcdetail) {
        this.pcdetail = pcdetail == null ? null : pcdetail.trim();
    }

    public String getPcfeatures() {
        return pcfeatures;
    }

    public void setPcfeatures(String pcfeatures) {
        this.pcfeatures = pcfeatures == null ? null : pcfeatures.trim();
    }
