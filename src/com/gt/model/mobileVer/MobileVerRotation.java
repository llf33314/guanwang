package com.gt.model.mobileVer;
...
@Entity
@Table(name = "t_ws_mobile_rotation")
@org.hibernate.annotations.Table(appliesTo = "t_ws_mobile_rotation", comment = "移动端首页轮播图")
public class MobileVerRotation {
	@Id
	@GeneratedValue
