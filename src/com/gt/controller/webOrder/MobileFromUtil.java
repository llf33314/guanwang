...
public class MobileFromUtil {
	...
	public static void ip138(String phone){
		try {
			DefaultHttpClient client = new DefaultHttpClient();
			HttpGet request = new HttpGet("http://www.ip138.com:8080/search.asp?action=mobile&mobile="+phone);
//			HttpPost request = new HttpPost("http://www.ip138.com:8080/search.asp?action=mobile&mobile="+phone);
	...
	public static void httpClientGet(String phone){
...
//		System.out.println(getMobileFrom("15013990984"));
		ip138("15013990984");
	}
