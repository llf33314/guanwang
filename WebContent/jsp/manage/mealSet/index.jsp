	                    ...
	                    <div class="block-content collapse in">
	                        <div class="span12">
	                           <div class="table-toolbar">
	                              <div class="btn-group">
	                                 <a href="javascript:void(0);" onclick="gtView('/jsp/manage/mealSet/edit.jsp')">
	                              ...
	                              <div class="btn-group">
	                                 <a href="javascript:void(0);" onclick="gtView('/jsp/manage/mealSet/typeIndex.jsp')">
		...
		WSFUNCTION.initTables({
			...
			columns: [
			         ...
			         }, 
			         {
			        	 ...
			        	 col: "",
			        	 render: function(value){
			        		 return "<a class='btn btn-success' onclick='gtView(\"/jsp/manage/mealSet/edit.jsp?i="+value.id+"\")'>修改</a>&nbsp;"+
			        		 	"<a class='btn btn-danger' onclick='WSFUNCTION.sendDel(\"mealSet/del\",{id:"+value.id+"}, \"/jsp/manage/mealSet/index.jsp\", $(this))'>删除</a>"; 
			        	 }
			         }
			        ],
			url: "/mealSet/html/list",
			param: {}
		});
