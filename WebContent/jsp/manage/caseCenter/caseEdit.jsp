...
<body>
						...
						<fieldset>
							...
							<div class="control-group" id="atarashi1">
								<div class="plus-btn-div">
									<input type="button" value="客户案例介绍" class="btn-sel"/><!-- <span class="deruta"></span> -->
									<input type="button" value="+ 添加项目" onclick="cbonclick()"/>
								</div>
								<span class="help-inline"></span>
								<textarea typeset="客户案例介绍" style="resize: none;width: 900px;height: 292px;"
							...
							<div class="control-group" id="atarashi2">
								...
								<span class="help-inline"></span>
								<img id="imgurl2" src="/images/duofenIntroduction/plus.png" typeset="客户案例介绍" onclick="a_imgClick(this)" 
									style="height: 200px;margin-left: 50px;border: 1px solid #ccc;"/>
							</div>
	...
	<script type="text/javascript">
		...
		var hitotsufueer = function(){
			...
			var sel_boxs = $('#sel-box input[type="checkbox"]'), h = '<input type="button" value="客户案例介绍" onclick="irohenka(this)"/>';
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			if(id != null){
				...
				var a_h = '<input type="button" class="btn-sel" value="客户案例介绍" onclick="irohenka(this)"/>';
				for(var i=0;i<two.length;i++){
					var a_two = two[i];
					if(a_two.proname != '客户案例介绍'){
