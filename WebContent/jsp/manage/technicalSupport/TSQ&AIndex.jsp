	                    ...
	                    <div class="block-content collapse in">
	                        <div class="span12">
	                           <div class="table-toolbar">
	                              <div class="btn-group">
	                                 <a href="javascript:void(0);" onclick="gtView('/jsp/manage/technicalSupport/TSQ&AEdit.jsp')">
		...
		WSFUNCTION.initTables({
			...
			columns: [
			         ...
			         }, 
			         {
			        	 ...
			        	 col: "",
			        	 render: function(value){
			        		 return "<a class='btn btn-success' onclick='gtView(\"jsp/manage/technicalSupport/TSQ&AEdit.jsp?i="+value.id+"\")'>修改</a>&nbsp;"+
			        		 	"<a class='btn btn-danger' onclick='WSFUNCTION.sendDel(\"technicalSupport/delQandA\",{id:"+value.id+"}, \"/jsp/manage/technicalSupport/TSQ&AIndex.jsp\", $(this))'>删除</a>"; 
			        	 }
			         }
			        ],
			url: "technicalSupport/html/QandAList",
			param: {}
		});
