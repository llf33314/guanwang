...
<div class="a-box">
    <div class="b-register-box" id="bRegister">
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0" class="demo-ruleForm">
            ...
            <div style="position: relative">
                <el-form-item label="" prop="inputNumber" style="width: 280px;" :error="errors.inputNumber" :class="error4Flag ? 'demo-ruleForm4':'b-password'">
        ...
        <button class="b-submit" id="sSubmit" @click="submitForm('ruleForm')" @keyup.13="submitForm('ruleForm')">登录</button>
    </div>
</div>
...
//                              return "redirect:"+agentLogin_url+"/agentLogin?user_name="+sendName+"&passWord="+MD5Util.getMD5(pwd);
                                        ...
                                        if(data.type == 1){
                                            ...
                                            self.errors = {name: '账号或密码错误'};
                                        }else if(data.type == 3){

                                            self.errors = {inputNumber: '短信验证码不能为空'};
                                        }else if(data.type == 4){
                                            self.error4Flag = false
