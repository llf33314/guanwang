...
<head>
    <meta charset="UTF-8">
    <title>多粉样子智慧美业管理系统_会员_预约_收银_支付软件_用多粉，好生意</title>
...
<div class="response_shows animated" id="choice4" style="opacity: 0;">
    <div class="response_shows_box wow bounceIn cd-section" id="section5">
        <div class="pc" onclick="goToSYRJ()" style="cursor:pointer">
            ...
            <div class="pic">
                <a href="javascript:void(0);" onclick='lookopenVideo2();'><div class="item"><img src="../images/sy24.png" /></div></a>
                <a href="javascript:void(0);" onclick='WSFUNCTION.videoFrame("https://v.qq.com/iframe/player.html?vid=b0507nf8yen&auto=0&tiny=0&auto=0");'><div class="item"><img src="../images/sy25.png"/></div></a>
                <a href="javascript:void(0);" onclick='lookopenVideo1();'><div class="item"><img src="../images/sy26.png"/></div></a>
            </div>
        </div>
        <div class="thumb"></div>
    </div>
