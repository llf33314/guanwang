...
<head>
    <meta charset="utf-8">
    <meta name="description" content="粉丝通过邀请好友来点亮灯笼，当达到奖品的兑换规则时即可兑换相应的奖品。企业需在后台设置灯笼名称，每个灯笼点亮概率以及奖品兑换规则企业可以在后台设置。"/>
    <title>多粉点灯笼_微信公众号游戏功能</title>
    ...
    <div class="containter">
        ...
        <div class="vote-main clear">
            <div class="fl vote-content-left">
                ...
                <div class="vote-icon">
                    <a href="">
                        <img src="${imageUrl}/product-center/light-icon.png" alt="">
    ...
    <h3>摇一摇周边</h3>
            ...
            <div class="fr vote-content-right">
                ...
                <p class="product-desc">
                    粉丝通过邀请好友来点亮灯笼，当达到奖品的兑换规则时即可兑换相应的奖品。企业需在后台设置灯笼名称，每个灯笼点亮概率以及奖品兑换规则企业可以在后台设置，点灯笼小游戏支持单个点亮和多个组合点亮，两者均可随机设置奖品。
                </p>
                <div class="show-vote">
                    <ul class="show-vote-img">
                        <li class="show-img">
                            <img class=" " src="${imageUrl}/product-center/light-poster.png" alt="">
                        </li>
