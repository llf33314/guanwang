...
<script>
    ...
    var productOpenVideo00 = function(){
        ...
        $('#product-video-box00').show();
				...
				<h3>扫一扫，立即体验!</h3> <ul class="a-details-3-pix"><li class="a-details-3-pix-li"><div class="a-details-ewm"><img style="width: 150px;height: 150px;" src="http://maint.duofriend.com/upload/image/websiteUpload/website/C09557D25CACA1849073638758B29CDA.png">
					<p style=" margin-top: -10px;">过分的话发个</p>
