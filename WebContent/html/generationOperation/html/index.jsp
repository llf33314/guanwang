...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../Y-poer/iconfont.css" />
...
<div class="a-in-swiper-box">
	<div class="a-in-swiper-big-box" style="display:block" id="id1">
		<div class="a-operate-gen">
			...
			<img src="../images/oper4.png" style="margin: 42px 0 50px;">
		...
		<div class="a-operate-second">
			<div class="a-operate-gen">
				...
				<img src="../images/oper5.png" style="margin: 30px 0 42px;">
			</div>
		</div>
		<div class="a-operate-gen">
			...
			<p>占据绝对优势</p>
			<img src="../images/oper6.png" style="margin: 50px 0 55px;">
		</div>
		...
		<div class="a-operate-gen" style="width: 1252px;">
			...
			<ul class="a-operate-more-ul">
					...
					<div class="a-operate-ewm">
						...
						<div class="a-operate-ewm-ac" style="display: none;">
							<div class="a-operate-ewm-ac-box">
								<img src="../images/mqy.png" style="padding: 80px 0 24px;">
				...
				<li class="a-operate-more-ul-li">
					<img src="../images/oper10.png" class="a-operate-more-pix">
					<h3>爱车屋</h3>
					...
					<div class="a-operate-ewm">
						...
						<div class="a-operate-ewm-ac" style="display: none;">
							<div class="a-operate-ewm-ac-box">
								<img src="../images/acw.png" style="padding: 80px 0 24px;">
								<p class="a-operate-ewm-ac-box-p">扫描浏览</p>
							</div>
						</div>
					</div>
				...
				<li class="a-operate-more-ul-li">
					<img src="../images/oper11.png" class="a-operate-more-pix">
					<h3>邦国酒店</h3>
					...
					<div class="a-operate-ewm">
						...
						<div class="a-operate-ewm-ac" style="display: none;">
							<div class="a-operate-ewm-ac-box">
								<img src="../images/bg.png" style="padding: 80px 0 24px;">
								<p class="a-operate-ewm-ac-box-p">扫描浏览</p>
							</div>
						</div>
					</div>
		...
		<div class="combo-container">
			...
			<table class="main-table">
				<tboby>
					...
					<tr class="combo-item">
						<td>视频直播培训</td>
						<td class="right-cancel"><img  src="../images/oper14.png" alt=""></td>
						<td class="right-cancel">2次/年</td>
						<td class="right-cancel">2次/年</td>
						<td class="right-cancel">2次/年</td>
					</tr>
					...
					<tr class="combo-item">
						<td>会员基础方案策划</td>
						<td class="right-cancel"><img src="../images/oper15.png" alt=""></td>
						<td class="right-cancel"><img src="../images/oper15.png" alt=""></td>
						<td class="right-cancel"><img src="../images/oper15.png" alt=""></td>
						<td class="right-cancel"><img src="../images/oper15.png" alt=""></td>
					</tr>
