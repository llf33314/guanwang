	...
	function gtShow(id, t) {
        ...
        $(t).find("a").attr("style","color:#fff;background-image: url(/html/generationOperation/images/oper3.png);background-repeat: no-repeat; background-position: center;height: 80px;");
	if(id==2){
