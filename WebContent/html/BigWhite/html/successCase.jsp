	       ...
	       <div class="big-clinic-box">
	         <img src="../images/care1.png" style="position: relative;top: 49px;left: 50%;" class="mated1 infinite zoomIn"/>
                ...
                <div class="big-clinic-box-right">
		            ...
		            <p style="margin-top: 75px;text-indent: 2em;" class="mated4 infinite zoomInLeft">小红十ERP系统配备智能化的药品管理系统，采用扫码的方式轻松完成药品入库，而且门诊可以选择是否将数据实时同步到线上药店，药品库存告急时系统将自动提示，帮助社区门诊实现药品库存的轻松管理，
		            使用小红十ERP系统后，普仁诊所不再需要担心库存问题，而且针对不同的季节有针对性地进行营销，线上药店销售业绩同比增长93% </p>		            
                </div>
	       </div>    
	  </div>
	  <div class="big-west">
	       <div class="big-west-box animated"> 
	            <div class="big-west-box-left animated" style="opacity: 0;">
	                 <h5>使用效果</h5>
	                 <p style="text-indent: 2em;">小红十ERP智能化前台帮助工作人员快速完成挂号、预约等操作，大大缩短了就医者排队等待的时间。而且小红十ERP还支持患者通过手机端以及小程序端线上直接预约挂号，
	                 实现有效分流，大大减少排队人数。除此之外，小红十ERP还支持现金、银联支付、扫码支付等多种诊金支付方式，患者直接线上搞定、无需反复缴费排队。
           ...
           <div class="big-service-box"> 
              ...
              <div class="big-service-top" style="margin-top:5px;">       
	                ...
	                <div class="big-service-top-right animated" style="opacity: 0;" id="service4">
	                     <h5>使用效果</h5>
	                     <p style="text-indent: 2em;">小红十ERP系统直接连通硬件设备，结果出来后系统自动将各类的化验报告、检验单的相关数据同步到ERP系统，系统自动建立个人电子健康档案。
医生直接在PC端查看患者个人健康档案，快速问诊，提高运营效率。在同样的工作时间内，医生问诊效率提高43%，为众康门诊服务部带来了36%的营业收入增长量。而且小红十ERP还为众康门诊服务部提供了便捷的医患沟通渠道，患者可在微信以及小程序端直接线上咨询医生。
医生也可以在PC或手机端快速回复患者的诊后的问题反馈，改善医患关系。除此之外，小红十ERP系统还能实现数据自动统计、自动生成报表，管理层可以随时通过PC端、微信端、以及小程序查看销售数据，医生问诊数据等情况</p>
	                </div>
              </div>        
           </div>   
      </div>
      <div class="car-more animated">
		     <h1 class="animated"  id="more-txt" style="opacity: 0;">更多的社区门诊正在使用小红十ERP</h1>
