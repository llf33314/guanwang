...
<div class="xcx-big">
    ...
    <div class="box">
        ...
        <a class="cxb-gobtn" href="http://duofriend.com/user/toregister.do">
            ...
            <i class="clearmid"></i>
            <div>更多</div>
            <img class="rower" src="/html/applet/img/rower.png" />
        </a>
    </div>
</div>
<div class="xcx-floor2">
    <div class="w1200">
        ...
        <div class="imgs">
            <img class="img1" src="/html/applet/img/xcx-floor21.png" />
            <img class="img2" src="/html/applet/img/xcx-floor22-1.png" id="wpox1" />
            <img class="img2" src="/html/applet/img/xcx-floor22-2.png" id="wpox2" />
        </div>
    </div>
</div>
<div class="xcx-floor3">
    <div class="w1200">
        ...
        <img class="img" src="/html/applet/img/xcx-floor31.png" />
    </div>
</div>
<div class="xcx-floor4">
    <div class="w1200">
        ...
        <img class="img" src="/html/applet/img/xcx-floor41.png" />
    </div>
</div>
<div class="xcx-floor5">
    <div class="w1200">
        ...
        <div class="imgs">
            <img class="img" src="/html/applet/img/xcx-floor51.png" />
            <span>
             <div class="wx-s1" id="td1"></div>
            <img class="wx-img1" src="/html/applet/img/xcx-floor53.png" />
          </span>
            <span>
             <div class="wx-s2" id="td2" style="display:none ;"></div>
            <img class="wx-img2"  src="/html/applet/img/xcx-floor52.png" />
          </span>
            <span>
             <div class="wx-s3" id="td3" style="display:none ;"></div>
            <img class="wx-img3" src="/html/applet/img/xcx-floor53.png" />
          </span>
        </div>
    </div>
</div>
...
<div class="xcx-floor7">
    <div class="w1200">
        ...
        <div class="imgs animated">
            <img class="img3" src="/html/applet/img/xcx-floor71.png" style="position: absolute;" />
...
<script src="/html/applet/js/thead.js"></script>
<script src="/html/applet/js/hweight.js"></script>
