...
<!-- 立即评价 -->
<div class="a-at-evaluation" id="checkMsg" style="display: none">
    <div class="a-at-row">
        <div class="a-at-left">
            <div class="head" style="background-image: url(../images/head.jpg)"></div>
            <span class="a-star-title">星级：</span><el-rate style="float: left;" disabled v-model="starNumber"></el-rate>
        </div>
