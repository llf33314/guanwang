  ...
  <div style="width: 100%;" class="second-js-top">
	<div class="a-case-customer">
	   <ul class="a-case-customer-txt">
	      <li  ng-repeat="(index1,buspro1) in busproList" class="a-case-customer-txt-li a-se-txt"><a href="javascript:void(0);" ng-click="locationCase(index1)">{{buspro1.proname}}</a></li>
	   </ul>
	</div>
  </div>
<div class="a-case">
