...
!function(B, d, C) {
    var z = function() {
        ...
        f.prototype.scaleRaphael = function(b, c, d) {
            ...
            var l;
            "VML" == Raphael.type ? (e.innerHTML = "<rvml:group style='position : absolute; width: 1000px; height: 1000px; top: 0px; left: 0px' coordsize='1000,1000' class='rvml' id='vmlgroup_" + b + "'></rvml:group>", 
            l = document.getElementById("vmlgroup_" + b)) :(e.innerHTML = '<div class="svggroup"></div>', 
            l = e.getElementsByClassName("svggroup")[0]);
            var q = new Raphael(l, c, d), f;
            "SVG" == Raphael.type ? q.canvas.setAttribute("viewBox", "0 0 " + c + " " + d) :f = e.getElementsByTagName("div")[0];
            q.changeSize = function(b, m, h, k) {
                k = !k;
                var n = b / c, a = m / d, g = n < a ? n :a, n = parseInt(d * g), a = parseInt(c * g);
                if ("VML" == Raphael.type) {
                    var y = document.getElementsByTagName("textpath"), u;
                    for (u in y) {
                        var v = y[u];
                        if (v.style) {
                            if (!v._fontSize) {
                ...
                e.style.height = n + "px";
                q.setSize(a, n);
                h && (e.style.position = "absolute", e.style.left = parseInt((b - a) / 2) + "px", 
                e.style.top = parseInt((m - n) / 2) + "px");
            };
        ...
        f.prototype.render = function() {
            var b = this.options, c = this.dom, f = eval(b.mapName + "MapConfig"), e = {};
            "xml" == b.stateDataType ? d.ajax({
                ...
                success:function(u) {
                    ...
                    d(a).find("stateData").each(function(a) {
                        var u = d(this), c = u.attr("stateName");
                        e[c] = {};
                        a = 0;
            ...
            var l = function(a) {
                var c = d(a.node).offset().left + d(a.node).outerWidth() / 2, f = d(a.node).offset().top + d(a.node).outerHeight() / 2, e = b.tipWidth, h = b.tipHeight, k = a.direction, m = b.tipOuterH, n = b.tipOuterW, q = a = 0, g = [], l = [], p = [], w = [], x = [], r = e, t = h;
                "left" == k || "right" == k ? (r = e + n, t = h, f -= t / 2, "left" == k ? (c -= r, 
                g = [ r, t / 2 ], l = [ 0, 0 ], p = [ e, 0 ], w = [ 0, t ], x = [ e, t ]) :(a = n, 
                g = [ 0, t / 2 ], l = [ r, 0 ], p = [ n, 0 ], w = [ r, t ], x = [ n, t ])) :(r = e, 
                t = h + m, "top" == k ? (c -= r / 2, f -= t, g = [ r / 2, t ], l = [ 0, 0 ], p = [ 0, h ], 
                w = [ r, 0 ], x = [ r, h ]) :(q = m, c -= r / 2, g = [ r / 2, 0 ], l = [ 0, t ], 
                p = [ 0, m ], w = [ r, t ], x = [ r, m ]));
                ...
                return [ c, f, a, q ];
            }, q = this.scaleRaphael(c.attr("id"), f.width, f.height), z = {
                cursor:"",
            ...
            var i=0;
            for (h in f.shapes) {
                var k = e[h], n = "#" + (k && b.stateColorList[k.stateInitColor] || b.stateInitColor || f.names[h].color), a = "#" + (k && k.stateHoverColor || b.stateHoverColor), g = "#" + (k && k.stateSelectedColor || b.stateSelectedColor), k = "#" + (k && k.stateDisabledColor || b.stateDisabledColor);
                p[h] = {};
                p[h].initColor = n;
                p[h].hoverColor = a;
                p[h].selectedColor = g;
                ...
                var g = a.getBBox().x + f.names[h].x, y = a.getBBox().y + f.names[h].y, g = q.text(g, y, a.name).attr({
                    cursor:"",
                    metadata:{
                        mapId:1
                    }
